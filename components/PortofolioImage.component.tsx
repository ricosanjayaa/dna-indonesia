...
export default function PortofolioImage({ src, type }: { src: string, type: 1 | 2 | 3 | 4 }) {
  ...
  return (
    <div className="relative w-full aspect-[4/5] rounded-xl overflow-hidden group">
      <Image width={1080} height={1080} className="h-full aspect-[4/5] object-cover rounded-t-md rounded-b-md group-hover:rounded-b-none group-hover:scale-105 transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)]" src={src} alt={"Portofolio " + typeAfter + " DNA Indonesia"} />
